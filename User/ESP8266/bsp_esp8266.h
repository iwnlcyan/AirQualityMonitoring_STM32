...
/********************************User Variables*********************************/
#define      macUser_ESP8266_ApSsid                       "sampleWIFIname"       //Wi-Fi name
#define      macUser_ESP8266_ApPwd                        "sampleWIFIpassword"           //Wi-Fi password

#define      macUser_ESP8266_TcpServer_IP                 "sampleIPaddress"      //server IP
#define      macUser_ESP8266_TcpServer_Port               "sampleport"               //server port

/******************************* ESP8266 external global variables declaration***************************/
#define RX_BUF_MAX_LEN     1024                                     //Max Buffer Length

extern struct  STRUCT_USARTx_Fram                                  //Structure processing the serial data frames
{
...
/******************************** ESP8266 connection pins definition ***********************************/
...
#define      macESP8266_RST_PIN                               GPIO_Pin_13
...
/*********************************************** ESP8266 function macro definition*******************************************/
...
void ESP8266_StaTcpClient_startUnvarnishTest ( void );
