...
extern void TmDelay_measure(void);
extern u32 Get_TmDelay_measure(void);
extern void TmDelay_measureClr(void);
extern void TmDelay_measureSet(void);
...
void GPS_USART_IRQHandler(void)
{
  //uint8_t ucCh;
	...
	{
		//ucCh  = USART_ReceiveData( GPS_USART );
	}
}
